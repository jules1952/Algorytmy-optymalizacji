...
int NO_IMPROVEMENT_LIMIT = 20; // warunek stopu
...
int main()
{
    ...
    for (int generation = 0; generation < GENERATIONS; generation++)
    {
        ...
        // Jeśli nie udało się dopełnić populacji, uzupełniamy ją bez sprawdzania par
        ...
        else
        {
            cout << "Generacja " << generation + 1
                 ...
                 << " | brak poprawy od " << noImprovementCounter
                 << " generacji\n";
        }

        // ===========================
        // WARUNEK STOPU
        // stop tylko wtedy, gdy istnieje już poprawne rozwiązanie
        // ===========================
        if (!bestSolution.empty() && noImprovementCounter >= NO_IMPROVEMENT_LIMIT)
        {
            cout << "\nBrak poprawy przez " << NO_IMPROVEMENT_LIMIT
